...
content = content.replace("const lesson: Lesson = {", "await db.curriculumVersions.add({ id: 'v1', name: 'Curriculum', isArchived: false, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() });\n    const lesson: Lesson = {");
