  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h2 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-white break-words">Observations</h2>
          <p className="text-xs sm:text-sm text-slate-500 break-words">Pedagogical notes & behaviour tracking</p>
        </div>
